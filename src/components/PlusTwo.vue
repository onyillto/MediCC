<template>
  <div class="bg-neutral-50 min-h-screen flex flex-col items-center justify-center px-4 relative">
    ...
    <!-- Form Container (Flexbox for large screens) -->
    <div class="flex flex-col lg:flex-row gap-8 justify-center w-full max-w-[1200px]">
      ...
      <div class="bg-white shadow-lg shadow-gray-800 rounded-lg p-6 mt-8 w-full max-w-md lg:w-[700px]">
        ...
        <form @submit.prevent="handleFirstInviteSubmit">
          <div class="mb-4">
      ...
      <div class="bg-white shadow-md rounded-lg p-6 mt-8 w-full max-w-md lg:w-[700px]">
        <h3 class="text-lg font-[28px] font-semibold text-gray-800 mb-4">Second Invite: Plus One Data</h3>
        <p class="text-sm font-[16px] text-gray-500 mb-6">Specify exactly as in your passport or National Identification</p>
        <form @submit.prevent="handleSecondInviteSubmit">
          <div class="mb-4">
            <label for="first-name" class="block text-sm font-[19px] text-gray-700">First name<span class="text-red-500">*</span></label>
            <input
              id="first-name"
...
export default {
  ...
  methods: {
    handleFirstInviteSubmit() {
      console.log("First Invite Submitted", this.firstInvite);
      alert("First invite submitted successfully!");
    },
    handleSecondInviteSubmit() {
      console.log("Second Invite Submitted", this.secondInvite);
      alert("Second invite submitted successfully!");
    },
  },
};
</script>
